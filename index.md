...
humandate: "March 5-6, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Elysia Chou", "Mark Ciechanowski", "Huda Hassoun"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Gregory Johnson", "Natasha Vernooij"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2025-03-05-UMich  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
googleform: "https://forms.gle/1CmRvU4dmPS4sJyPA" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
<a href="https://forms.gle/1CmRvU4dmPS4sJyPA">Registration Link</a> You will need to sign in to your Google account to view the registration form.
